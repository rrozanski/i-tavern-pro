    ...
    export default Vue.extend({
        ...
        methods: {
            generateAbilities(): void {
                this.dexterity = Math.floor(Math.random() * 20) + 1;
                this.strength = Math.floor(Math.random() * 20) + 1;
                this.wisdom = Math.floor(Math.random() * 20) + 1;
